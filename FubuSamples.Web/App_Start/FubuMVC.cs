...
[assembly: WebActivator.PreApplicationStartMethod(typeof(FubuSamples.Web.App_Start.AppStartFubuMVC), "Start", callAfterGlobalAppStart: true)]
...
namespace FubuSamples.Web.App_Start
{
    public static class AppStartFubuMVC
    {
        ...
        {
            ObjectFactory.Initialize(cfg => cfg.AddRegistry<ValidationRegistry>());
